          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#bbbac4] focus:shadow-md"
              />
            </div>
